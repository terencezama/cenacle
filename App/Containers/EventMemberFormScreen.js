...
// Styles
import styles from './Styles/EventMemberFormScreenStyle'
import { View } from 'react-native-animatable';

class EventMemberFormScreen extends Component {
  ...
  static navigationOptions = ({ navigation }) => {
    ...
    if(navigation == null || navigation == undefined){
      options.title = i18n.t('screenEventMemberFormTitle')
      return options
   }
  ...
  constructor(){
    super();
    this.ref = firebase.firestore().collection('member_events')
    this.state = {
      initialValues: {
        date: new Date,
        time: '01:00 PM'
...
export default connect(mapStateToProps, mapDispatchToProps)(EventMemberFormScreen)
