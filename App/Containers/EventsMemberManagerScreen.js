...
// Styles
import styles from './Styles/EventsMemberManagerScreenStyle'
import firebase from 'react-native-firebase'
import otron from 'reactotron-react-native'
import AwesomeIcon from 'react-native-vector-icons/FontAwesome'
import NotifyActions from '../Redux/NotifyRedux'

class EventMemberManagerScreen extends Component {
  static navigationOptions = {
    title: 'Events Member Manager',
  };
  //region Initializing
  constructor(props) {
    super(props)
...
export default connect(mapStateToProps, mapDispatchToProps)(EventMemberManagerScreen)
